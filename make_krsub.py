...
def translate_text(text, target_language): 
    response = openai.Completion.create( 
        engine=engine, 
        prompt=f'Translate the following text into {target_language} without further explanation and write only in colloquial Korean: {text}',
        max_tokens=400, 
        n=1, 
        stop=None, 
        temperature=1, 
...
with open(args.input_file, 'r', encoding='utf-8') as file:
    for line in file:
        ...
        translated_text = translate_text(korean_text, 'korean')
