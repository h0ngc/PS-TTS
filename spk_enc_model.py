...
# from TTS.config import load_config, load_config_from_datadict
# from TTS.encoder.models.resnet import ResNetSpeakerEncoder

# from resampy import resample

# import saved_model_state_dict
...
#     def __init__(self):
#         super().__init__()
#         #config = load_config("./config_se.json")
#         #state = torch.load('saved_model_state_dict.pth')
#         config = load_config_from_datadict(datadict)
#         state_dict = saved_model_state_dict.model_dict
#         state = {}
...
#     se_enc = SpeakerEncoder()
#     wav, sr = sf.read('/mnt/db/VCTK-Corpus/wav48/p225/p225_104.wav')
#     emb = se_enc(torch.from_numpy(wav.astype(np.float32)))
